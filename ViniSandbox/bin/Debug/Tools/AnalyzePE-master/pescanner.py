    ...
    if sys.modules.has_key('magic'):
        try:
            ...
            try:
                ...
                magic_custom = magic.Magic(magic_file='C:\gnuwin32\GetGnuWin32\gnuwin32\share\misc\magic')
...
if __name__ == "__main__":
    ...
    pescan = PEScanner(files, 'C:\Users\Vinicius\Downloads\AnalyzePE-master\AnalyzePE-master\\apt1.yara', 'C:\Users\Vinicius\Downloads\AnalyzePE-master\AnalyzePE-master\userdb.txt')
    pescan.collect(verb)
